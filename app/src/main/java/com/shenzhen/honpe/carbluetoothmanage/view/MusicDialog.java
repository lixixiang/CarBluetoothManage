...
/**
 * FileName: MusicDialog
 * Author: asus
 * Date: 2021/6/22 12:01
 * Description:
 */
public class MusicDialog extends AppCompatDialog {
    ...
    public MusicDialog(Context context, int style) {
        super(context, style);
    ...
    public MusicDialog applyStyle(int styleId) {
    ...
    public MusicDialog cancelable(boolean cancelable){
        super.setCancelable(cancelable);
        mCancelable = cancelable;
        return this;
    }

    public MusicDialog canceledOnTouchOutside(boolean cancel){
     ...
     */
    public MusicDialog contentView(View v){
        mContentView = v;
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public MusicDialog contentView(int layoutId){
        if(layoutId == 0)
            return this;
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public MusicDialog heightParam(int height){
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public MusicDialog inDuration(int duration){
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public MusicDialog inInterpolator(Interpolator interpolator){
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public MusicDialog outDuration(int duration){
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public MusicDialog outInterpolator(Interpolator interpolator){
